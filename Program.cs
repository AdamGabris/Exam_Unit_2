...
Console.WriteLine($"Server Answer: {Colors.Green}{task1AnswerResponse}{ANSICodes.Reset}");
...
Console.WriteLine($"Server Answer: {Colors.Green}{task2AnswerResponse}{ANSICodes.Reset}");
...
Console.WriteLine($"Server Answer: {Colors.Green}{task3AnswerResponse}{ANSICodes.Reset}");
...
Console.WriteLine($"Server Answer: {Colors.Green}{task4AnswerResponse}{ANSICodes.Reset}");

Console.WriteLine("\n-----------------------------------\n");
Console.WriteLine("End of Assignment 2");